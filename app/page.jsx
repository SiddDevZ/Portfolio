          ...
          <div className="flex flex-col md:flex-row flex-1 max-h-[100rem] md:pt-0">
            ...
            <div className="md:w-1/3 flex flex-col justify-between md:justify-end pb-10 md:pb-10 mt-10 md:mt-0 relative order-last md:order-first">
              ...
              <div className="md:hidden flex justify-end mb-3">
                <button className="font-inter mb-2 bg-[#ffffff08] font-medium text-white/70 text-xs border border-white/10 px-3 py-1.5 rounded-full hover:bg-[#ffffff12] transition-all ease-out duration-200 hover:scale-[1.025]">
                  Download Resume
                </button>
              </div>

              <div className="mb-4 md:mb-5 hidden md:block">
                <button className="font-inter bg-[#ffffff08] font-medium text-white/70 text-sm border border-white/10 px-4 py-2 rounded-full hover:bg-[#ffffff12] transition-all ease-out duration-200 hover:scale-[1.025]">
                  Download Resume
                </button>
              </div>
            ...
            <div className="p-6 sm:p-8 md:p-10">
              <div className="flex flex-col">
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4">
                  <button className="px-3 sm:px-4 py-1.5 sm:py-2 border-2 border-[#00eeff]/30 text-[#00eeff]/80 bg-[#00eeff]/5 rounded-xl hover:bg-[#00eeff16] transition-all ease-out hover:scale-[1.028] duration-300 text-xs sm:text-sm tracking-wider">
                    View Website
                  </button>

                  <button className="px-3 sm:px-4 py-1.5 sm:py-2 border-2 border-[#666666] text-[#bdbdbd] bg-[#747474]/5 rounded-xl hover:bg-[#262626] transition-all ease-out hover:scale-[1.028] duration-300 text-xs sm:text-sm tracking-wider">
                    Case Study
                  </button>
                </div>
              </div>
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-2.5">
                    ...
                    <button className="px-3 sm:px-4 py-1 sm:py-1.5 border-2 border-[#666666] text-[#bdbdbd] bg-[#747474]/5 rounded-xl hover:bg-[#262626] transition-all ease-out hover:scale-[1.028] duration-300 text-[0.7rem] sm:text-[0.8rem] tracking-wider whitespace-nowrap">
                      Case Study
                    </button>
                  </div>
                </div>
                ...
                <div className="flex flex-col justify-between h-full">
                  {[
                    ...
                    },
                    {
                      ...
                      date: "2023 - 2025",
                      company: "DanBot Hosting",
                      description: "I handled their website development, which included creating a managing ticketing system, and integrating it with their existing infrastructure.",
                      borderColor: "border-[#00eeff]/50",
                      bgColor: "bg-[#00eeff]/20",
                      // icon: "🌐"
                    }
                  ].map((entry, index) => (
                    <div key={index} className="relative pl-8 sm:pl-10 group mb-8 md:mb-0">
                      ...
                      <div className="bg-gradient-to-br from-[#111111] to-[#131313] rounded-xl p-5 sm:p-6 border border-white/5 transform group-hover:translate-x-[6px] transition-all duration-300 hover:shadow-[0_5px_15px_rgba(0,0,0,0.2)] hover:border-white/10">
                        <div className="flex items-start justify-between">
                          ...
                          <span className="text-[#00eeff]/80 text-xs font-medium bg-[#00eeff]/5 px-2 py-1 rounded-full">{entry.date}</span>
                        </div>
                        <div className="text-white/60 text-xs sm:text-sm mb-2.5 font-medium">{entry.company}</div>
